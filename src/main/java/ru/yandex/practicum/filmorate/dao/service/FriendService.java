...
public class FriendService {
    ...
    @Autowired
    public FriendService(JdbcTemplate jdbcTemplate, UserDbStorage userDbStorage) {
    ...
    public void addFriend(int friend1Id, int friend2Id) {
        ...
        String sqlQuery = "insert into USER_FRIEND (USER_ID, USER_FRIEND_ID) " + "values (?, ?)";
        jdbcTemplate.update(sqlQuery,
                friend1Id,
                friend2Id
        );
        log.info("User " + friend1Id + " add friend user " + friend2Id);
    }
    ...
    public void deleteFriend(int friend1Id, int friend2Id) {
        ...
        log.info("User " + friend1Id + " deleted friend user " + friend2Id);
    }
